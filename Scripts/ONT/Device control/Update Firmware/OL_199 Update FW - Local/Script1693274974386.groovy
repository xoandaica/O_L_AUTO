...
Mobile.callTestCase(findTestCase('Test Cases/ONT/Device control/Update Firmware/OL_193 Access to Update FW - Local'), null, FailureHandling.STOP_ON_FAILURE)


EzAction ez = new EzAction()
//Chọn model name và Firmware version
Mobile.tap(findTestObject('Object Repository/ONT/Update Firmware/model_name'), 30)
ez.tapElementByText(GlobalVariable.ONTModel) 
ez.tapElementByText('Chọn file')
ez.tapElementByText(GlobalVariable.ONTFirmware)
...
Mobile.waitForElementPresent(updateFW_success, 120)
