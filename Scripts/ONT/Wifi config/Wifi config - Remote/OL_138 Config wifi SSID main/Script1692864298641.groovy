...
// Click WiFi Main 2.4G index 0
TestObject wifiMain = findTestObject('Object Repository/ONT/Network config/Wifi config/wifiMain')
Mobile.tap(wifiMain, 0) 
...
// Set new SSID name  
String ONTserial = GlobalVariable.ONTSerial
String newName = ONTserial + 'Main2.4G' + Randomv.getHexStringFromTimestamp().substring(6, 10)
...
Mobile.callTestCase(findTestCase('Test Cases/ONT/Wifi config/Wifi config - Remote/OL_138 Config wifi SSID main'), [('earlyAssert') : 'true', ('ssidNameAssert') : newName], FailureHandling.STOP_ON_FAILURE)
