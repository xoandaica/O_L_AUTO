...
Mobile.callTestCase(findTestCase('Test Cases/ONT/Wifi config/Wifi config - Local/OL_138 Config wifi SSID main'), [('earlyAssert') : 'true', ('ssidNameAssert') : newName], FailureHandling.STOP_ON_FAILURE)
