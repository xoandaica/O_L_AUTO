...
Mobile.callTestCase(findTestCase('Test Cases/Mesh/Dashboard/Local/OL_25 Device detail - MRE'), [('newSessionDetail') : 'false'], FailureHandling.STOP_ON_FAILURE)
