...
Mobile.callTestCase(findTestCase('Test Cases/Mesh/Device control/Delete Device/Remote/OL_107 Access Delete Device screen success'), [('newSessionDelete') : 'false'], FailureHandling.STOP_ON_FAILURE)

EzAction ez = new EzAction()

MobileElement CAP = ez.findContains('CAP', 0)

TestObject CAPObj = ez.createTestObject('//*[contains(@content-desc, "CAP")]')
Mobile.tap(CAPObj, 30)
