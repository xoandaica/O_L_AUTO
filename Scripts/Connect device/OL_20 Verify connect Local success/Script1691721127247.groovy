...
Mobile.callTestCase(findTestCase('Test Cases/Connect device/Connect wifi'), null, FailureHandling.STOP_ON_FAILURE)
...
//Xác nhận đang ở màn Dashboard local: Check màn có button Dashboard và button Thêm mesh
