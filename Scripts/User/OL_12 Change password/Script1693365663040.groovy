...
TestObject txt_success = ez.createTestObjectFromText('Đổi mật khẩu thành công. Vui lòng đăng nhập lại với mật khẩu vừa đổi.')
Mobile.verifyElementExist(txt_success, 30)
ez.tapElementByText('Đăng nhập')
WebUI.callTestCase(findTestCase('User/OL_02 Login success'), [('password'): newPassword, ('newSession'): 'false'], FailureHandling.CONTINUE_ON_FAILURE)
