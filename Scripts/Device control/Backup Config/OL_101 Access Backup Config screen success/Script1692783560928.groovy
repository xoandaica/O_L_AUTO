...
ez.tapElementByText('Backup Config')

//Xác nhận đã vào màn Backup Config
Mobile.waitForElementPresent(ez.createTestObjectFromText('Quản lý File Backup'), 30)
Mobile.waitForElementPresent(ez.createTestObjectFromText('Xóa File Backup'), 30)
