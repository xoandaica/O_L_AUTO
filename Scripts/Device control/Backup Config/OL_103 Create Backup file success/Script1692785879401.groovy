...
Mobile.callTestCase(findTestCase('Test Cases/Device control/Backup Config/OL_101 Access Backup Config screen success'), [('newSessionBackup') : 'false'], FailureHandling.STOP_ON_FAILURE)
