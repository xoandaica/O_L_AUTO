...
if(checkbox_MRE == null) {
	...
	Mobile.verifyElementNotExist(hello, 30)
	Mobile.verifyElementExist(findTestObject('Object Repository/Mesh/Device/Device control/Reboot/reboot_title'), 30)
	Mobile.verifyElementExist(findTestObject('Object Repository/Mesh/Device/Device control/Reboot/btn_reboot_device'), 30)
}
